...
public class Utils {
    ...
    public static String getStringByFormat(String welcome, String regex, String invalidMessage) {
        while (true) {
            String input = getString(welcome);
    ...
    public static String getOptionalString(String welcome) {
        Scanner sc = new Scanner(System.in);
        System.out.print(welcome);
        return sc.nextLine();
    }
    ...
    public static float getFloat(String welcome, int min, int max, int oldData) {
        boolean check = true;
